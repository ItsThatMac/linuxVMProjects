...
int main() 
{
  ...
  ret=pthread_create(&thread_id,NULL,&resource_write,NULL);
  sleep(2);
  ret=pthread_create(&thread_id1,NULL,&resource_read,NULL);
  sleep(5);
  printf("\n Created thread");
